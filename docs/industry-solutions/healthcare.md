...
![PACS Workflow](../images/pacs_workflow.svg)
...
| 需求 | 解决方案 | 核心价值 |
| :--- | :--- | :--- |
| **影像存储** | **Orthanc (Docker)** | 私有化 PACS，无需高昂授权费 |
| **隐私合规** | **加密文件夹** | 即使硬盘被盗也无法读取 |
| **数据备份** | **3-2-1 策略** | 确保病历数据万无一失 |
| **远程协作** | **File Station** | 安全、可控的医疗数据分享 |

群晖 NAS 帮助诊所低成本实现了“三甲医院级”的数据管理能力。
