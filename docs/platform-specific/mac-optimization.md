...
**SMB Multichannel 原理图：**

![SMB Multichannel](../images/smb_multichannel.svg)
...
Mac 与群晖 NAS 的配合可以天衣无缝。关键在于：**SMB 多通道** 解决速度问题，**传输协议优化** 解决 Time Machine 慢的问题，**索引优化** 解决搜索慢的问题。按照本指南配置后，你的 NAS 将像本地硬盘一样丝滑。
