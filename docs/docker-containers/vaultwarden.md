...
## 11. 进阶安全加固 (Security Hardening)

自建密码库，安全是第一位的。如何防止暴力破解？如何自动备份数据库？

*   **Fail2Ban 防御**：封禁连续输错密码的 IP。
*   **YubiKey / 2FA**：即使密码泄露，黑客也进不去。
*   **数据库自动备份**：防止数据丢失。

👉 **详细操作请参考**：[Vaultwarden 安全加固与备份指南](vaultwarden-security.md)
